...
RCT_EXPORT_METHOD(publishToExchange:(NSString *)message exchange_name:(NSString *)exchange_name routing_key:(NSString *)routing_key message_properties:(NSDictionary *)message_properties)
{
    ...
    if (exchange_id != nil){
        ...
        if ([message_properties objectForKey:@"headerType"] != nil && [[message_properties objectForKey:@"headerType"] isMemberOfClass:[NSString class]]){
            [properties addObject:[[RMQBasicReplyTo alloc] init:[[message_properties objectForKey:@"type"] stringValue]]];
        }
        if ([message_properties objectForKey:@"codeTaxi"] != nil && [[message_properties objectForKey:@"codeTaxi"] isMemberOfClass:[NSString class]]){
            [properties addObject:[[RMQBasicReplyTo alloc] init:[[message_properties objectForKey:@"codeTaxi"] stringValue]]];
        }
