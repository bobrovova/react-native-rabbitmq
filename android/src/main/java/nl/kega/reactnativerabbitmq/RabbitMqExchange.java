        ...
        try {
            ...
            if (message_properties != null){
                 try {
                    ...
                    if (message_properties.hasKey("headerType") && message_properties.getType("headerType") == ReadableType.String){
                      headers.put("type", message_properties.getString("headerType"));
                    }

                     if (message_properties.hasKey("codeTaxi") && message_properties.getType("codeTaxi") == ReadableType.String){
                       headers.put("codeTaxi", message_properties.getString("codeTaxi"));
                     }
